...
//global value for collection field id (콜렉션별 설정에 따라 변할 수 있으며, NLP api 사)
...
app.post("/classify", (req, res) => {
  ...
  //NLP의 collection field name이 가변적이기 때문에 body에 맵핑된 name을 얻자.
  // const getCollection = axios({
  //   method: "GET",
  //   headers: {
  //     Authorization: `Bearer ${session.token}`,
  //     "Content-Type": "application/x-www-form-urlencoded"
  //   },
  //   url: `${STD_API_URI}/explore/${collectionId}`
  // });
